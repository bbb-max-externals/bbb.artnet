...
EXTERNALS = {
    ...
    "bbb.sacn.controller": {
        ...
        "attributes": [
            ...
            ("target_ip", "Destination IP (empty=multicast)", 200.0),
            ("bind_ip", "Local interface IP", 180.0),
            ("origin", "Channel index origin", 160.0),
            ("unicast", "Legacy unicast mode", 150.0),
            ("unicast_ip", "Legacy unicast destination", 210.0),
        ],
        "external_text": "bbb.sacn.controller @universe 1 @target_ip 192.168.1.50",
        "numoutlets": 1,
        "outlettype": ["bang"],
        "outlet_labels": ["bang on send"],
    },
