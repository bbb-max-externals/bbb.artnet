		...
		"boxes": [
			...
			},
			{
				"box": {
					...
					"style": "",
					"text": "Store one Art-Net port-address without sending"
				}
			},
			{
				"box": {
			...
			},
			{
				"box": {
					...
					"style": "",
					"text": "bang on send; list on dump"
				}
			}
		],
		"lines": [
